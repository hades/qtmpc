...
bool MusicLibrarySortFilterModel::filterAcceptsArtist(const MusicLibraryItem * const item) const
{
	switch(_filterField) {
		case 0: // Artist
...
bool MusicLibrarySortFilterModel::filterAcceptsAlbum(const MusicLibraryItem * const item) const
{
	switch(_filterField) {
		case 0: // Artist
...
bool MusicLibrarySortFilterModel::filterAcceptsSong(const MusicLibraryItem * const item) const
{
	switch(_filterField) {
		case 0: // Artist
...
bool MusicLibrarySortFilterModel::filterAcceptsRow(int sourceRow, const QModelIndex &sourceParent) const
{
...
#include <QDebug>
bool MusicLibrarySortFilterModel::lessThan(const QModelIndex &left, const QModelIndex &right) const
{
...
int MusicLibrarySortFilterModel::filterField() const
{
	return _filterField;
}
